...
namespace Cota.Core.Business
{
    ...
    /// </summary>
    public sealed class UserBus : Dataclass.User, Cota.Core.ExtentionBase.IBusinessTemp<UserBus>, Cota.Core.ExtentionBase.IBusiness
    {
        /// <summary>
        ...
        public bool changePassword(long UserID, string oldPass, string newPass)
        {
            ...
            if (((Cota.Core.Dataclass.User)ub).password != oldPass)
            {
